# Finanly
MVP de um SaaS de gestão financeira mobile-first, desenvolvido em React, com autenticação, dashboard financeiro e calendário simples para controle de encomendas.
Perfeito. Para GitHub o ideal é:
